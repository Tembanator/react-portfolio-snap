...
const WorkItem = () => {
    ...
    return (
        <div
            ...
            <div
                className='absolute w-full h-full left-0 bottom-0 right-0 top-0 opacity-0 group-hover:opacity-100 duration-300 aspect-square bg-gradient-to-r from-sky-500 to-indigo-500 flex flex-col justify-center items-center gap-4'>
